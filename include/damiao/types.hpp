...
enum class ControlMode : uint8_t { Mit, PositionSpeed, Speed };
...
constexpr std::array<uint8_t, 8> ENABLE_CMD = {0xFF, 0xFF, 0xFF, 0xFF,
                                                0xFF, 0xFF, 0xFF, 0xFC};
constexpr std::array<uint8_t, 8> DISABLE_CMD = {0xFF, 0xFF, 0xFF, 0xFF,
                                                 0xFF, 0xFF, 0xFF, 0xFD};
constexpr std::array<uint8_t, 8> SAVE_ZERO_CMD = {0xFF, 0xFF, 0xFF, 0xFF,
                                                   0xFF, 0xFF, 0xFF, 0xFE};
constexpr std::array<uint8_t, 8> CLEAR_ERROR_CMD = {0xFF, 0xFF, 0xFF, 0xFF,
                                                     0xFF, 0xFF, 0xFF, 0xFB};
